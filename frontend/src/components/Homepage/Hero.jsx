  ...
  return (
    <section>
      <div
        ...
        px-6 md:px-16 lg:px-24 xl:px-64 mt-8 md:mt-24"
      >
        <div className="max-w-[38rem] max-md:mt-7">
          <h1 className="font-bold text-5xl md:text-6xl text-black">
            Laundry Bersih 
            <span className="px-3 text-blue-500">Hidup Praktis</span>
          </h1>
          <p className="mt-8 text-gray-500 text-sm sm:text-base max-w-lg">
            Lebih Banyak Waktu untuk Anda, Biar Kami Urus Cucian Anda.
          </p>
          ...
          <div class="flex items-center mt-6">
            ...
            <button className="flex items-center gap-2 px-8 py-2.5">
              Pelajari Lagi
        ...
        <img
          class="max-w-80 md:max-w-[465px] w-full max-md:mt-8"
